// ESTE CÓDIGO USA LA SINTAXIS MÁS ESTABLE Y ROBUSTA PARA VERCEL (CommonJS)

// 1. Importar la librería de forma directa
const bizSdk = require('facebook-nodejs-business-sdk');
const crypto = require('crypto');

// 2. Acceder a las clases de Meta (Sin desestructuración directa para evitar errores)
